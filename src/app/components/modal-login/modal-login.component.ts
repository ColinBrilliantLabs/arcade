...
export class ModalLoginComponent implements OnInit {
  ...
  submit() {
    ...
    if (this.state == "login"){
      ...
      console.log("Do sign up stuff");
      this.userAuthService.createUser(this.emailInput,this.passwordInput,this.nicknameInput)
      //Then means it was a succes (resolve)
      .then(userData=>{
        //This code will happen after our user has been created
